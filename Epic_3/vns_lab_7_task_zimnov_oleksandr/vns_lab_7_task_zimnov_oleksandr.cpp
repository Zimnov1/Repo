...
int sum(int number1, int number2, int number3, int number4, int number5, int number6, int number7, int number8, int number9, int number10, int number11, int number12) {
    int result=number1*number2+number2*number3+number3*number4+number4*number5+number5*number6+number6*number7+number7
    *number8+number8*number9+number9*number10+number10*number11+number11*number12;
    return result;
}
